...
El **código fuente** del proyecto se incluye dentro del fichero de RMarkdown. [Está disponible en este enlace](https://github.com/gustavoquevedo/uimp/kaggle.rmd).
...
El usuario utilizado para cargar las predicciones es **gustavoquevedo** y a continuación se pueden ver una captura de pantalla con el *score* final obtenido:
